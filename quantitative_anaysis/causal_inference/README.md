...
|----------|-------------------|--------|
| Minimum Wage Effect | Does increasing the minimum wage improve household income after accounting for selection bias? | [Results](causal_inference/ground_truth_interventions/minimum_wage_effect/results.md) |
