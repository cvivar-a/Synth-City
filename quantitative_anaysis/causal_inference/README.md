...
|----------|-------------------|--------|
| Minimum Wage Effect | Does increasing the minimum wage improve household income after accounting for selection bias? | [Results](/ground_truth_interventions/minimum_wage_effect/results.md) |
